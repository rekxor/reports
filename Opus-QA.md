...
| [NC-04](#nc-04-abbotcairo-event-please-define-the-struct-before-defining-the-event-for-enhanced-readability) | abbot.cairo :: event Please define the `struct` before defining the `event` for enhanced readability | _Non Critical_ |
